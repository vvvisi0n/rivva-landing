  ...
  return (
    <main className="mx-auto max-w-3xl px-6 pt-16 pb-20">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-xl">
        <p className="text-xs uppercase tracking-widest text-white/50">Chat</p>
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-white">Invite required</h1>
        <p className="mt-4 text-sm text-white/70 leading-relaxed">
          Chats unlock after you are invited.
        </p>
