...
// ✅ What your pages want:
export const FEED = MOCK_MATCHES;     // used by /liked
export const MATCHES = MOCK_MATCHES;  // used by /inbox

// ✅ Simple deterministic “seed” for chat previews.
// You can expand later into real AI chat.
